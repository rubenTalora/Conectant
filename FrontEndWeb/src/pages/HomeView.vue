  ...
  <BaseLayout>
    <section class="page">
      ...
      <template v-if="isAuthenticated">
        <div class="dashboard">
          <main class="content">
            <h1 class="welcome">Aqui esta tu página web... </h1>
          </main>
          ...
          <transition name="fade">
            <div
              v-if="showPopup"
              class="fixed bottom-24 right-6 z-40 w-80 rounded-3xl border border-slate-200 bg-white p-5 shadow-2xl md:w-96"
            >
